...
-(NSDictionary *)jsonToDict:(NSData *)json{
	...
	NSDictionary *blurb = [NSDictionary dictionaryWithObject:[MMMarkdown HTMLStringWithMarkdown:[self objectForKeypath:@"tabs.0.views.2.markdown" inJSON:json] error:&error] forKey:@"title"];
